...
import { ALL_PRODUCT_FAIL, ALL_PRODUCT_REQUEST, ALL_PRODUCT_SUCCESS, CLEAR_ERROR,
...
export const newReview = (reviewData) => async (dispatch) => {
  ...
  export const getAllReviews = (id) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`/api/v1/vendor/reviews?id=${id}`);
